...
const statusNoWatch = 'https://icons.iconarchive.com/icons/paomedia/small-n-flat/1024/sign-question-icon.png';
const statusWatch = 'https://netlock.hu/wp-content/uploads/2019/02/tick.png';

    // create message items
const createMess = ({title, author, date, link, id}) => {
    ...
    const iconStatus = localStorage.getItem(id) ? statusNoWatch: statusWatch;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    download.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            fromServerWithLove.map((item) => {
                ...
                itemWrapper.append(createMess(item));
    ...
    widget.addEventListener('click', (e) => {
        if (e.target.className === 'itemMess__itemLink') {
            ...
            status.style.background = `url('${statusWatch}') center center/cover no-repeat`;
        }
    })
